$(document).ready(function() {
    ...
    const fillForm = (form, data) => {
        Object.keys(data).forEach((key) => {
            ...
            if (key === "dias_lectivos") {
                ...
                const diasLectivosArray =
                    data[key] !== null ? data[key].split(",") : [];
                checkboxes.forEach((checkbox) => {
                    checkbox.checked = diasLectivosArray.includes(
                        checkbox.value
                    );
                });
            }
    ...
    // Buscar DNI
    // const formBuscarDNI = document.getElementById("verificarDNIForm");
    // formBuscarDNI.addEventListener("submit", async function (e) {
    //     e.preventDefault();
