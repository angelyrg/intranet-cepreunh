...
@section('content')
    ...
    <div class="row">
        ...
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">{{ $descripcion }}</h4>
    ...
    <div class="card w-100 position-relative overflow-hidden">
        <div class="px-4 py-3 border-bottom">
            <form id="form{{ $title }}" action="{{ route('asignaturaciclo.store') }}" method="post">
                        ...
                        <div class="input-group mt-3" style="flex-wrap: nowrap !important">
                            <div class="input-group-text">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input selectAllOptions" id="chkAsignaturaCiclo" value="check">
                                    <label class="form-check-label" for="chkAsignaturaCiclo"></label>
                                </div>
                                <span class="txtAllOptions">Seleccionar todo</span> 
                            </div>
                            <select class="form-control select2-icons" placeholder="Seleccionar" multiple="multiple" id="asignatura_id{{ $title }}" name="asignatura_id[]">
                                {!! $sltAsignaturas !!}
                            </select>
        ...
        <div class="card-body p-4">
            <div class="mb-4 rounded-1">
                <div class="row" id="tbl{{ $title }}">
                    <div class="col">
                        <table class="table table-bordered border text-nowrap m-1 align-middle" id="tblAsignaturas">
                            <thead class="text-dark fs-4">
                                <tr>
                                    <th class="bg-light text-center" style="width: 10%;">
                                        <div class="btnActionAsignatura badge py-1 btn bg-info-subtle">
                                            <a class="mx-auto my-auto" title="Seleccionar toda las asignaturas">
                                                <input type="checkbox" class="form-check-input btnRemoveAsignaturaAll inputAsignatura" data-idarea="1" data-chkall="1" value="check">                                        
                                            </a>
                                            <span class="badge btn bg-danger-subtle text-danger ms-2 btnDelete{{ $title }}" title="Remover asignaturas seleccionadas" style="display:none">
                                                <i class="ti ti-trash my-1 mx-auto"></i>
                                            </span>
                                        </div>
                                    </th>
                                    <th class="bg-light">
                                        <h6 class="fs-4 fw-semibold">Asignaturas</h6>
                                    </th>
                                </tr>
                            </thead>
                            <tbody>                   
