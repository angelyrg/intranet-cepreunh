...
<div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
    <div class="card-body px-4 py-3">
        <div class="row align-items-center">
            <div class="col-9">
                <h4 class="fw-semibold mb-8">Editar área</h4>
...
<div class="card">
    <div class="card-body p-4">
        <form action="{{ route('areas.update', $area->id) }}" method="POST">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="mb-4 form-group">
                        ...
                        <input type="text" name="nombre_area" class="form-control @error('nombre_area') is-invalid @enderror" value="{{ old('nombre_area', $area->nombre) }}" autofocus>
                        @error('nombre_area')
            ...
            <div class="text-end">
                <a href="{{ route('intranet.areas.index') }}" class="btn btn-light px-4 mt-3">
                    Volver
                </a>
