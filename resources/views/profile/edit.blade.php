    ...
    <div class="tab-content" id="pills-tabContent">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="card shadow-none border">
                        <div class="card-body">
                            ...
                            <p>
                                Hello, I am Mathew Anderson. I love making websites
                                and graphics. Lorem ipsum dolor sit amet, consectetur
                                adipiscing elit.
                            </p>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card">
                        <div class="card-body border-bottom">
                            <div class="d-flex align-items-center gap-3">
                                <img src="../assets/images/profile/user-1.jpg" alt="" class="rounded-circle"
                                    width="40" height="40" />
                                <h6 class="fw-semibold mb-0 fs-4">Mathew Anderson</h6>
                                <span class="fs-2"><span class="p-1 text-bg-light rounded-circle d-inline-block"></span>
                                    15 min ago</span>
                            </div>
                            <p class="text-dark my-3">
                                Nu kek vuzkibsu mooruno ejepogojo uzjon gag fa ezik
                                disan he nah. Wij wo pevhij tumbug rohsa ahpi ujisapse
                            ...
                            <div class="position-relative">
                                <div class="p-4 rounded-2 text-bg-light mb-3">
                                    ...
                                    <p class="my-3">
                                        Lufo zizrap iwofapsuk pusar luc jodawbac zi op
                                        uvezojroj duwage vuhzoc ja vawdud le furhez siva
                                        fikavu ineloh. Zot afokoge si mucuve hoikpaf adzuk
                                        zileuda falohfek zoije fuka udune lub annajor gazo
                                        conis sufur gu.
                                    </p>
                                ...
                                <div class="p-4 rounded-2 text-bg-light mb-3">
                                    ...
                                    <p class="my-3">
                                        Zumankeg ba lah lew ipep tino tugjekoj hosih
                                        fazjid wotmila durmuri buf hi sigapolu joit ebmi
                                        joge vo. Horemo vogo hat na ejednu sarta afaamraz
                                        zi cunidce peroido suvan podene igneve.
                                    </p>
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex align-items-center gap-2">
                                ...
                                <div class="p-4 rounded-2 text-bg-light ms-7">
                                    ...
                                    <p class="my-3">
                                        Olte ni somvukab ugura ovaobeco hakgoc miha
                                        peztajo tawosu udbacas kismakin hi. Dej zetfamu
                                        cevufi sokbid bud mun soimeuha pokahram vehurpar
                                        keecris pepab voegmud zundafhef hej pe.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body border-bottom">
                            <div class="d-flex align-items-center gap-3">
                                <img src="../assets/images/profile/user-5.jpg" alt="" class="rounded-circle"
                                    width="40" height="40" />
                            ...
                            <p class="text-dark my-3">
                                Pucnus taw set babu lasufot lawdebuw nem ig bopnub
                                notavfe pe ranlu dijsan liwfekaj lo az. Dom giat gu
                                sehiosi bikelu lo eb uwrerej bih woppoawi wijdiola
                    ...
                    <div class="card">
                        <div class="card-body border-bottom">
                            <div class="d-flex align-items-center gap-3">
                                <img src="../assets/images/profile/user-2.jpg" alt="" class="rounded-circle"
                                    width="40" height="40" />
                            ...
                            <p class="text-dark my-3">
                                Faco kiswuoti mucurvi juokomo fobgi aze huweik
                                zazjofefa kuujer talmoc li niczot lohejbo vozev zi
                                huto. Ju tupma uwujate bevolkoh hob munuap lirec zak
                                ja li hotlanu pigtunu.
                            </p>
                            <div class="row">
                                <div class="col-sm-6">
                            ...
                            <div class="p-4 rounded-2 text-bg-light">
                                <div class="d-flex align-items-center gap-3">
                                    <img src="../assets/images/profile/user-3.jpg" alt="" class="rounded-circle"
                                        width="33" height="33" />
                                    <h6 class="fw-semibold mb-0 fs-4">
                                        Ritesh Deshmukh
                                    </h6>
                                ...
                                <p class="my-3">
                                    Hintib cojno riv ze heb cipcep fij wo tufinpu
                                    bephekdab infule pajnaji. Jiran goetimip muovo go en
                                    gaga zeljomim hozlu lezuvi ehkapod dec bifoom hag
                    ...
                    <div class="card">
                        <div class="card-body border-bottom">
                            ...
                            <iframe class="rounded-4 border border-2 mb-3" src="https://www.youtube.com/embed/d1-FRj20WBE"
                                frameborder="0" width="100%" style="height: 300px"></iframe>
                            <div class="d-flex align-items-center">
                                <div class="d-flex align-items-center gap-2">
                                    <a class="d-flex align-items-center justify-content-center text-bg-primary p-2 fs-4 rounded-circle"
                                        href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="top"
        ...
        <div class="tab-pane fade" id="pills-followers" role="tabpanel" aria-labelledby="pills-followers-tab"
            ...
            <div class="d-sm-flex align-items-center justify-content-between mt-3 mb-4">
                <h3 class="mb-3 mb-sm-0 fw-semibold d-flex align-items-center">
                    Followers
                    <span class="badge text-bg-secondary fs-2 rounded-4 py-1 px-2 ms-2">20</span>
                </h3>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card">
                        <div class="card-body p-4 d-flex align-items-center gap-3">
                            <img src="../assets/images/profile/user-4.jpg" alt="" class="rounded-circle"
                                width="40" height="40" />
                            <div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card">
                        <div class="card-body p-4 d-flex align-items-center gap-3">
                            <img src="../assets/images/profile/user-6.jpg" alt="" class="rounded-circle"
                                width="40" height="40" />
                            <div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card">
                        <div class="card-body p-4 d-flex align-items-center gap-3">
                            <img src="../assets/images/profile/user-7.jpg" alt="" class="rounded-circle"
                                width="40" height="40" />
                            <div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card">
                        <div class="card-body p-4 d-flex align-items-center gap-3">
                            <img src="../assets/images/profile/user-8.jpg" alt="" class="rounded-circle"
                                width="40" height="40" />
                            <div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card">
                        <div class="card-body p-4 d-flex align-items-center gap-3">
                            <img src="../assets/images/profile/user-9.jpg" alt="" class="rounded-circle"
                                width="40" height="40" />
                            <div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card">
                        <div class="card-body p-4 d-flex align-items-center gap-3">
                            <img src="../assets/images/profile/user-10.jpg" alt="" class="rounded-circle"
                                width="40" height="40" />
                            <div>
        ...
        <div class="tab-pane fade" id="pills-gallery" role="tabpanel" aria-labelledby="pills-gallery-tab"
            ...
            <div class="d-sm-flex align-items-center justify-content-between mt-3 mb-4">
                <h3 class="mb-3 mb-sm-0 fw-semibold d-flex align-items-center">
                    Gallery
                    <span class="badge text-bg-secondary fs-2 rounded-4 py-1 px-2 ms-2">12</span>
                </h3>
                <form class="position-relative">
                    <input type="text" class="form-control search-chat py-2 ps-5" id="text-srh"
                        placeholder="Search Friends" />
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="p-4 d-flex align-items-center justify-content-between">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu overflow-hidden">
                                        <li>
                                            <a class="dropdown-item" href="javascript:void(0)">Ip docmowe
                                                vemremrif.jpg</a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="p-4 d-flex align-items-center justify-content-between">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu overflow-hidden">
                                        <li>
                                            <a class="dropdown-item" href="javascript:void(0)">Duan cosudos
                                                utaku.jpg</a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="p-4 d-flex align-items-center justify-content-between">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu overflow-hidden">
                                        <li>
                                            <a class="dropdown-item" href="javascript:void(0)">Orewac huosazud
                                                robuf.jpg</a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="p-4 d-flex align-items-center justify-content-between">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu overflow-hidden">
                                        <li>
                                            <a class="dropdown-item" href="javascript:void(0)">Nira biolaizo
                                                tuzi.jpg</a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="p-4 d-flex align-items-center justify-content-between">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu overflow-hidden">
                                        <li>
                                            <a class="dropdown-item" href="javascript:void(0)">Vurnohot tajraje
                                                isusufuj.jpg</a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="p-4 d-flex align-items-center justify-content-between">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu overflow-hidden">
                                        <li>
                                            <a class="dropdown-item" href="javascript:void(0)">Povipvez marjelliz
                                                zuuva.jpg</a>
                                        </li>
                                    </ul>
                                </div>
